...
"""
function genesysmod_dataload_one_node_storage(Switch)
    ...
    if Switch.switch_infeasibility_tech == 1
        ...
        # to calculate / try
        FixedCost[:,"D_Trade_Storage_Power",:] .= 0.0001
        CapitalCost[:,"D_Trade_Storage_Power",:] .= 0.0001
        VariableCost[:,"D_Trade_Storage_Power",:,:] .= 0.0001
        ...
        CapitalCostStorage[:,"S_Trade_Storage_Power",:] .= 0.0001
        TechnologyToStorage["D_Trade_Storage_Power", "S_Trade_Storage_Power", 1, :] .= 0.95
        TechnologyFromStorage["D_Trade_Storage_Power", "S_Trade_Storage_Power", 2, :] .= 0.95
        OperationalLifeStorage["S_Trade_Storage_Power"] .= 100
