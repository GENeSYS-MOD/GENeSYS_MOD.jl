...
# data_base_region="FR",
# # switch_processed_results =1,
# extr_str_results = "dispatch_representative_Paris",
# extr_str_dispatch = "run_representative_Paris"
# );
...
extr_str_results = "storage_dispatch_FR"
# switch_processed_results =1
)
...
inputdir = joinpath(pkgdir(GENeSYS_MOD),"test","TestData","Inputs"),
resultdir = joinpath(pkgdir(GENeSYS_MOD),"test","TestData","Results"),
data_file="RegularParameters_Europe_openENTRANCE_technoFriendly_dispatch_DE",
hourly_data_file = "Timeseries_Europe_openENTRANCE_technoFriendly",
data_base_region = "DE",
switch_raw_results = 1,
# write_reduced_timeserie = 1,
year=2050,
extr_str_dispatch = "full_run",
extr_str_results = "storage_dispatch_DE"
# switch_processed_results =1
)