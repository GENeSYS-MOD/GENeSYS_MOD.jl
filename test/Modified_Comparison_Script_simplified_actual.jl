...
# Iterate through solvers and granularities (1, 2, and 3 days, corresponding to 182, 121, and 91 hours per year)
for solver_name in solver_names
    for n in [121, 91] # Change granularity [182, 121, 91]
        year = 2018
...
for (b, s, o, v, c) in zip(building_time["CPLEX"], solving_time["CPLEX"], objective_list["CPLEX"], n_var["CPLEX"], n_constr["CPLEX"])
