...
plot_roa(extr_str, tag_techno_sector, country, 2050, "Power", ["Infeasibility_Power"], colors, year_split = 1 / 9)
...
#plot_period_comparison_roa(extr_str_list, 1:9, "DE", 2050, tag_techno_sector, "Power", ["D_Heat_HLI", "D_Heat_HLDH", "D_Heat_HLB"], colors)
